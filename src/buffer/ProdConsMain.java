...
public class ProdConsMain {
	/**
	 * Arreglo donde guardo la configuracion de la ejecucion, lo hago
	 * para editar más rapido y no tener que buscar todos los elementos
	 * cada vez, una paja.
	 */
	private static int[] parametros = {10 ,60, 100, 10, 60 ,1000};
	/**
	 ...
	 */
	private static int produce = parametros[1];
	/**
	 ...
	 * produce * nProducer = consume * nConsumer
	 */
	private static int consume = parametros[4];
	/**
	 * Cantidad de productores
	 * produce * nProducer = consume * nConsumer
	 */
	private static int nProducers = parametros[0];
	/**
	 * Cantidad de consumidores
	 * produce * nProducer = consume * nConsumer
	 */
	private static int nConsumers = parametros[3];
	/**
